    ...
    private static void readFile(int aht_or_not) throws Exception{
        ...
        if(aht_or_not==1){
            if(last_line_tr_before_switch!=null){
                //HSI   F2019123000000000.00000000 2019090309140000025490.0000000000000001020
            ...
            while((line_tr = br_tr.readLine())!=null){
                if(line_tr.substring(0, 6).trim().equals(whatClassCode)){
                    if(line_tr.substring(6, 7).equals(futureORoption)){
                        ...
                        //HSI   F2019123000000000.00000000 2019090209140000025459.0000000000000001020
            ...
            if(last_line_tr_aht_before_switch!=null){
                //HHI   F2019092700000000.00000000 2019090317150000010042.0000000000000001001
            ...
            while((line_tr_aht = br_tr_aht.readLine())!=null){
                if(line_tr.substring(0, 6).trim().equals(whatClassCode)){
                    if(line_tr.substring(6, 7).equals(futureORoption)){
                        ...
                        //HSI   F2019092700000000.00000000 2019090217150000025495.0000000000000001001
